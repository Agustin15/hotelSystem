    ...
    window.onload = function() {
        ...
        switch (pagina) {
            ...
            default:
                ...
                $(".cargarHabitaciones").load("../../../controller/admin/reservas/editarHabitaciones/estandar.php");
                break;


            case "Deluxe":

                $(".cargarHabitaciones").load("../../../controller/admin/reservas/editarHabitaciones/deluxe.php");
                break;

            case "Suite":

                $(".cargarHabitaciones").load("../../../controller/admin/reservas/editarHabitaciones/suite.php");
                break;
